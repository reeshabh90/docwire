...
SOURCE_PATH="$PWD" VCPKG_KEEP_ENV_VARS="SOURCE_PATH;CMAKE_MESSAGE_LOG_LEVEL;DOCWIRE_TESTS_CONSOLE_LOGGING;OPENAI_API_KEY;OPENROUTER_API_KEY;ASAN_OPTIONS;TSAN_OPTIONS" ./vcpkg/vcpkg --overlay-ports=./ports install $VCPKG_DEBUG_OPTION docwire$FEATURES:$VCPKG_TRIPLET
